...
var plotly = require('plotly')("ishan1104", "0VDjDNbz01Wo1yFcTmXl")
...
function loadtest() {
    starttime = Date.now();
    mongoose.connect('mongodb+srv://ivij:ishanvij11@sit314.mnurn.mongodb.net/data');
    ...
    ledPublish(002, 'led2', parseInt(val) + 75);
    ledPublish(003, 'led3', parseInt(val) + 25);
    ledPublish(004, 'led4', parseInt(val) + 125);
